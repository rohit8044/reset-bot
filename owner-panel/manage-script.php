...
if(isset($_GET['file_name'])) { // Check if a file name has been provided
    ...
    if (file_exists($file_path)) {
      ...
      header("Refresh: 1; url=manage-script.php");
      exit();
  } else {
...
if(isset($_GET['files_name'])) {
    ...
    if(!$result) {
        ...
        $_SESSION['inc']= "<script>swal({title:'Success',text:'Deleted File ".$fileName."',type:'success'});</script>";
    }
}
...
<head>
  ...
  <title>Manage Scripts - Blue Triple 4</title>
...
<div class="card">
  <h5 class="card-header">Manage Scripts</h5>
    ...
    <table class="datatables-ajax table table-bordered">
              ...
              <tbody> <?php
                  ...
                  <td><?php echo $row['created_at']; ?></td>
                    ...
                    <td><a href="?files_name=<?php echo $row['script_name']; ?>" style="color: red;"><button type="button" class="btn btn-danger">Delete</button>	
