...
if ($login_data['_user_type'] != "owner" && $login_data['_user_type'] != "member" && $login_data['_user_type'] != "reseller") {
	header("Location: ../login.php");
	exit();
}
  ...
  <h5 class="card-header"></h5>
      ...
      <div class="card-body">
        ...
        <ul class="list-unstyled mb-4 mt-3">
          ...
          <li class="d-flex align-items-center mb-3"><span class="fw-semibold mx-2">Role :</span> <span>Owner</span></li>
