...
<head>
  ...
  <title>Manage Libs - Blue Triple 4</title>
...
<div class="card">
  <h5 class="card-header">Manage Libs</h5>
    ...
    <table class="datatables-ajax table table-bordered">
              ...
              <tbody> <?php
                  ...
                  <td><?php echo $row['created_at']; ?></td>
                    ...
                    <td><a href="?files_name=<?php echo $row['lib_name']; ?>" style="color: red;"><button type="button" class="btn btn-danger">Delete</button>	
