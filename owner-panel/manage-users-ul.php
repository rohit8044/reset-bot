...
<head>
  ...
  <title>Manage Unlimited Device Users - Blue Triple 4</title>
...
<div class="card">
  <h5 class="card-header">Manage Unlimited Device Users</h5>
...
<?php } ?>
  ...
  <div class="table-responsive">
	...
	<thead>
							...
							<tbody>
								<?php 
								 $query_panel = mysqli_query($con,"SELECT * FROM panel WHERE `_version` = 'free' AND `_p_status` = 'paid' AND `_user_type` = 'member' ORDER BY _user_id ASC");
		...
		?></td>
								...
								<td><?php 
									...
									<?php if ($row['_status'] == "banned") { ?>
											<a href="manage-users-ul.php?unban=<?php echo $row['_username'];?>"><button type="button" class="btn btn-primary ml-1 text-xs"  style="margin: 0px 0px 0px 2px; background-color:#04d108; border-color:#04d108"><i class="fas fa-play"></i></button></a>
											
											<?php } ?>
					<?php if ($row['_status'] == "active") { ?>
			<a href="manage-users-ul.php?ban=<?php echo $row['_username'];?>"><button type="button" class="btn btn-primary ml-1 text-xs" style="margin: 0px 0px 0px 2px; background-color:#ffaa00; border-color:#ffaa00"><i class="fas fa-ban"></i></button></a>
										<?php } ?>
										
										
										<a href="manage-users-ul.php?delete=<?php echo $row['_username'];?>"><button type="button" class="btn btn-primary ml-1 text-xs" onClick="return confirm('Do you really want to Delete?');" style="margin: 0px 0px 0px 2px; background-color:#FF005C; border-color:#FF005C"><i class="fas fa-circle-xmark"></i></button></a>
										
										
										
										<a href="add-days.php?account=<?php echo $row['_username'];?>"><button type="button" class="btn btn-primary ml-1 text-xs" style="margin: 0px 0px 0px 2px; background-color:#04d108; border-color:#04d108"><i class="fas fa-calendar-minus"></i></button></a><?php if ($row['_v_status'] == "not-verified"){?><a href="manage-users-ul.php?verify=<?php echo $row['_username'];?>" class="btn btn-success btn-sm mr-1" style="border-radius: 4px"><i class="dw dw-checked"></i></a><?php } ?></td>
								</tr>
								<?php } ?>																</tbody>
						</table>
					</div>
