...
<head>
  ...
  <title>Manage Registered User - Blue Triple 4</title>
...
<div class="card">
  <h5 class="card-header">Manage Registered Users</h5>
  ...
  <div class="table-responsive">
    <table class="datatables-ajax table table-bordered">
		<thead>
							...
							<tbody>
								<?php 
								 $query_panel = mysqli_query($con,"SELECT * FROM panel WHERE `_user_type` = 'member' AND `_p_status` = 'unpaid' ORDER BY _user_id ASC");
		...
		?></td>
								...
								<td><?php 
										...
										<?php if ($row['_status'] == "banned") { ?>
											<a href="manage-reg-users.php?unban=<?php echo $row['_username'];?>"><button type="button" class="btn btn-primary ml-1 text-xs"  style="margin: 0px 0px 0px 2px; background-color:#04d108; border-color:#04d108"><i class="fas fa-play"></i></button></a>
											
											<?php } ?>
					<?php if ($row['_status'] == "active") { ?>
			<a href="manage-reg-users.php?ban=<?php echo $row['_username'];?>"><button type="button" class="btn btn-primary ml-1 text-xs" style="margin: 0px 0px 0px 2px; background-color:#ffaa00; border-color:#ffaa00"><i class="fas fa-ban"></i></button></a>
										<?php } ?>
										
										
										<a href="manage-reg-users.php?delete=<?php echo $row['_username'];?>"><button type="button" class="btn btn-primary ml-1 text-xs" onClick="return confirm('Do you really want to Delete?');" style="margin: 0px 0px 0px 2px; background-color:#FF005C; border-color:#FF005C"><i class="fas fa-circle-xmark"></i></button></a>
										
										  <a href="manage-reg-users.php?reset=<?php echo $row['_username'];?>&uid=<?php echo $row['_uid'];?>"><button type="button" class="btn btn-primary ml-1 text-xs" style="margin: 0px 0px 0px 2px; background-color:#f09e07; border-color:#f09e07"><i class="fas fa-recycle"></i></button></a>
