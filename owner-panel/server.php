...
$h_status = $_POST['h_status'];
		if ($login_data['_user_type'] == "owner") {
	$update_query = mysqli_query($con, "UPDATE server SET `server_status` = '$status', server_h_status = '$h_status' WHERE server_name = 'panel'");
if ($update_query){
...
<head>
  ...
  <title>Server Status - Blue Triple 4</title>
  ...
  <div class="card-body">
    <form class="dt_adv_search" method="POST">
      <div class="row">
        ...
        <div class="mb-3">
          <label class="form-label" for="user-role">Apk Status</label>
	<select class="form-select" name="h_status">
				<option value="online" <?php if($server_data['server_h_status'] == "online"){ echo 'selected'; }?>>Online</option>
					<option value="main" <?php if($server_data['server_h_status'] == "main"){ echo 'selected'; }?>>Maintenance</option>
            ...
            <div class="position-relative form-group">
        <div class="mb-3">
          <label class="form-label" for="user-role">Server Status</label>
	<select class="form-select" name="status" >
				<option value="online" <?php if($server_data['server_status'] == "online"){ echo 'selected'; }?>>Online</option>
					<option value="main" <?php if($server_data['server_status'] == "main"){ echo 'selected'; }?>>Maintenance</option>
