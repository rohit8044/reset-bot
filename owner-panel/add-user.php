...
$check_if_exists = mysqli_num_rows(mysqli_query($con, "SELECT * FROM panel WHERE _username = '$username'"));
 ...
 if ($login_data['_user_type'] == "owner"){
  ...
  header("Location: " . BASE_URL . "info.php?id=$verifycode");
					exit();
	} else {
...
<head>
  ...
  <title>Add User - Blue Triple 4</title>
...
<?php } ?>
  ...
  <div class="card-body">
        ...
        <div class="col-12">
          <div class="row g-3">
            <div class="position-relative form-group">
              ...
              <input class="form-control dt-input dt-full-name" type="text" name="username" placeholder="Enter A Username">
            </div>
            <div class="position-relative form-group">
              <label class="form-label">Password</label>
              <input class="form-control dt-input" placeholder="Enter A Password" name="password" type="text">
            </div>
            	            <div class="position-relative form-group">
		<label class="form-label">Token</label>
		       <div class="input-group input-group-merge">
			<input readonly class="form-control dt-input" placeholder="Generate A Token" id="token" name="token" type="text">
	...
	<select class="form-select" name="version">
	                       <option value="injector">1 Device</option>
	            <option value="free">Unlimited Devices</option>

	</select>
        </div>
            <div class="position-relative form-group">
              <label class="form-label">Max Resets</label>
              <input class="form-control dt-input" name="resets" type="number" placeholder="" value="5">
            </div>
            <div class="position-relative form-group">
        <div class="mb-3">
          <label class="form-label" for="user-role">Days</label>
	<select class="form-select" name="exp_date">
	           <option value="<?php echo Date('Y-m-d h:i', strtotime('+1 day')); ?>" >1 Day</option>

			<option value="<?php echo Date('Y-m-d h:i', strtotime('+7 day')); ?>" >7 Days</option>
			<option value="<?php echo Date('Y-m-d h:i', strtotime('+15 day')); ?>" >15 Days</option>
<option value="<?php echo Date('Y-m-d h:i', strtotime('+30 day')); ?>" >30 Days</option>
<option value="<?php echo Date('Y-m-d h:i', strtotime('+999 day')); ?>" >Unlimited</option>
