        ...
        <div class="col-12">
          <div class="row g-3">
            <div class="position-relative form-group">
              ...
              <div
              <td>User Type : Member</td>
              </div>
              <div
              <td>Registered : <?php echo $dados['_reg_date']; ?></td>
              </div>
              <div
              <td>Expired : <?php echo $dados['_exp_date']; ?></td>
              </div>
              <?php if ($dados['_version'] == "free") { ?>
              <div
              <td>Device : Unlimited Device</td> 
              </div>
              <?php } ?>
              <?php if ($dados['_version'] == "injector") { ?>
              <div
              <td>Device : 1 Device</td> 
              </div>
              <?php } ?>
              <div
              <td>Max Resets : <?php echo $dados['_r_resets']; ?></td> 
              </div>
