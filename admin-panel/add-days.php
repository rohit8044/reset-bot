...
$check_if_exists = mysqli_num_rows(mysqli_query($con, "SELECT * FROM panel WHERE _username = '$username'"));
	...
	$update_query = mysqli_query($con, "UPDATE panel SET `_exp_date` = '$exp_date' WHERE _username = '$username'");
if ($update_query){
$_SESSION['inc'] = "<script>swal('Success', 'Account Has Been Updated', 'success');</script>";
} else {
...
<div class="card">
  <h5 class="card-header">Add Days</h5>
        ...
        <div class="col-12">
          <div class="row g-3">
            <div class="position-relative form-group">
              ...
              <input class="form-control dt-input dt-full-name" type="text" name="username" placeholder="Enter A Username" value="<?php echo ''.$_GET['account'].''; ?>" required />
            </div>
