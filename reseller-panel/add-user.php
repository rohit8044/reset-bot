...
if ($login_data['_credits'] < 1){
$_SESSION['inc'] = "<script>swal('Error', 'Access Denied, Exception : Insufficient Credits', 'error');</script>";
          ...
          <div class="row g-3">
            ...
            <div class="position-relative form-group">
              ...
              <input class="form-control dt-input" placeholder="Enter A Password" name="password" type="text" required />
                        ...
                        <div class="position-relative form-group">
		<label readonly class="form-label">Token</label>
		       <div class="input-group input-group-merge">
			<input class="form-control dt-input" placeholder="Generate A Token" id="token" name="token" type="text" required />
