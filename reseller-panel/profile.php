  ...
  <h5 class="card-header"></h5>
      ...
      <div class="card-body">
        ...
        <ul class="list-unstyled mb-4 mt-3">
          ...
          <li class="d-flex align-items-center mb-3"><span class="fw-semibold mx-2">Role :</span> <span>Reseller</span></li>

          <li class="d-flex align-items-center mb-3"><span class="fw-semibold mx-2">Credits :</span> <span>$<?php echo ''.$login_data['_credits'].'';?></span></li>
