        ...
        <div class="d-flex align-items-start justify-content-between">
          <div class="content-left">
            ...
            <div class="d-flex align-items-end mt-2">
              <h3 class="mb-0 me-2">Reseller</h3>
      ...
      <div class="card-body">
        <div class="d-flex align-items-start justify-content-between">
          <div class="content-left">
            <span>Members</span>
            <div class="d-flex align-items-end mt-2">
              <h3 class="mb-0 me-2"><?php $fetch_t = mysqli_query($con, "SELECT * FROM panel WHERE _user_type = 'member' AND  _registrar = '".$_SESSION['is_logged_in']."'");
	$count = mysqli_num_rows($fetch_t);
	echo $count; ?></h3>
              <small class="text-success"></small>
            </div>
      ...
      <div class="card-body">
        <div class="d-flex align-items-start justify-content-between">
          <div class="content-left">
            ...
            <div class="d-flex align-items-end mt-2">
              <h3 class="mb-0 me-2"><?php $fetch_t = mysqli_query($con, "SELECT * FROM panel WHERE _status = 'banned' AND  _registrar = '".$_SESSION['is_logged_in']."'");
	$count = mysqli_num_rows($fetch_t);
	echo $count; ?></h3>
              <small class="text-success"></small>
            </div>
      ...
      <div class="card-body">
        <div class="d-flex align-items-start justify-content-between">
          <div class="content-left">
            ...
            <div class="d-flex align-items-end mt-2">
              <h3 class="mb-0 me-2"><?php $fetch_t = mysqli_query($con, "SELECT * FROM panel WHERE _user_type = 'member' AND _exp_date < '$time' AND  _registrar = '".$_SESSION['is_logged_in']."'");
	$count = mysqli_num_rows($fetch_t);
	echo $count; ?></h3>
              <small class="text-success"></small>
            </div>
      ...
      <div class="card-body">
        <div class="d-flex align-items-start justify-content-between">
          <div class="content-left">
            <span>Credits</span>
            <div class="d-flex align-items-end mt-2">
              <h3 class="mb-0 me-2"><?php echo ''.$login_data['_credits'].''; ?></h3>
              <small class="text-success"></small>
            </div>
